"""
Django settings for ADK Flow Platform.
"""
...
INSTALLED_APPS = [
    # Daphne must be first to replace runserver with ASGI server
    "daphne",
...
# Flow Executor Settings
FLOW_EXECUTOR_CACHE_MAX_SIZE = int(os.environ.get("FLOW_EXECUTOR_CACHE_MAX_SIZE", "1000"))
FLOW_EXECUTOR_CACHE_TTL = int(os.environ.get("FLOW_EXECUTOR_CACHE_TTL", "3600"))
