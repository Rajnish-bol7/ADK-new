...
class Webhook(models.Model):
    """
    Webhook configurations for triggering flows externally.
    """
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    flow = models.ForeignKey(
        Flow,
    ...
    allowed_methods = models.JSONField(default=list)  # List of allowed methods
    ...
    def __str__(self):
        return f"Webhook {self.path} ({self.flow.name})"
